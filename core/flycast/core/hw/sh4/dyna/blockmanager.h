...
// NesStation dcfix8 (SAFE_MEM): poll code-locked RAM pages for writes once per
// frame and discard affected blocks exactly like the SIGSEGV path would.
// Only meaningful when NESSTATION_DC_SAFE_MEM is enabled.
...
inline static void bm_PollDirtyRamPages() {}
